  ...
  return (
    <div className="p-4">
      <div className="mb-2 flex gap-2 items-center">
        ...
        />
        <input
          className="border px-2 py-1 w-[420px]"
          placeholder="URL de imagen (https://...)"
          value={imageUrl}
          onChange={(e) => setImageUrl(e.target.value)}
        />
        <input
          className="border px-2 py-1 w-[280px]"
          placeholder="Link (opcional)"
          value={link}
          onChange={(e) => setLink(e.target.value)}
        />
        <input
          className="border px-2 py-1 w-16 text-right"
          type="number"
          min={0}
          value={order}
        ...
        <button className="border px-3 py-1" onClick={create} disabled={busy}>
          Crear
        </button>
      </div>
