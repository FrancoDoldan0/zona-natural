...
import Image from "next/image";
    ...
    $syms = import Link from "next/link";
import Image from "next/image";
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <div style={{ marginTop: 16, color: "#666" }}>
        {data.total} resultados Ã‚Â· PÃƒÂ¡gina {data.page}
      </div>
    </div>
  );
}.Groups[1].Value
    if ($syms -notmatch '\bsiteUrl\b') { "import { $syms, siteUrl } from ""@/lib/site"""; } else { import Link from "next/link";
import Image from "next/image";
import { siteUrl } from "@/lib/site";
import type { Metadata } from "next";
