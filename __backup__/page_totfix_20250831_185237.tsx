...
export default async function Page({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  // Preferir filtrado si viene del backend; si no, total general; ÃƒÂºltimo recurso, cantidad de items.
...
return (
    <div style={{ padding: 16 }}>
      ...
      <div style={{ marginTop: 16, display: "flex", alignItems: "center", gap: 12, justifyContent: "space-between", flexWrap: "wrap" }}>
        <div style={{ color: '#666' }}>
  {totalForView_ZN} resultados Â· PÃ¡gina {page} de {Math.max(page, pageCount)}
</div>
