...
export default async function Page({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  // LÃ³gica: si el server manda filteredTotal => usarlo; si hay filtros pero no hay total filtrado => items.length;
  // si no hay filtros => caer al total del server; Ãºltimo recurso => items.length
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <div style={{ marginTop: 16, display: "flex", alignItems: "center", gap: 12, justifyContent: "space-between", flexWrap: "wrap" }}>
        <div style={{ color: "#666" }}>{totalForView} resultados ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚· PÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡gina {page} de {pageCount}</div>
