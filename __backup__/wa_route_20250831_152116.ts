...
function isUy(e164: string | null): e164 is string { return typeof e164 === "string" && /^598\d{8,9}$/.test(e164); }
...
export async function GET(req: NextRequest) {
  ...
  if (!isUy(phoneE164)) {
    const msg = "phone debe ser un número uruguayo en internacional: 598 + 8–9 dígitos (ej: 59891234567 o 59821234567).";
